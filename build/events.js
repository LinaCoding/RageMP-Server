...
exports.default = (function () {
    ...
    mp.events.add("playerEnterColshape" /* PLAYER_ENTER_COLSHAPE */, function (player, colshape) {
        player.notify("You entered " + colshape.data.info.name);
    });
    mp.events.add("playerJoin" /* PLAYER_JOIN */, function (player) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/];
        });
    }); });
